...
import com.treasure.basic.ui.dialog.CenterDialogBuilder


/**
 * Created by treasure_ct on 2025/07/10
 * Description:
 */
object DialogExt {
    ...
    fun showCommonDialog(
        ...
        leftBtnText: String = context?.getString(R.string.confirm) ?: "确定",
        leftBtnColor: Int = R.color.colorPrimary,
        rightBtnText: String = context?.getString(R.string.cancel) ?: "取消",
    ...
    fun showSingleCommonDialog(
        ...
        content: String,
        title: String = context?.getString(R.string.hint) ?: "提示",
        BtnText: String = context?.getString(R.string.confirm) ?: "确定",
