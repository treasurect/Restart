...
class DropPopupWindow<T>(
    ...
    fun show() {
        val contentView = LayoutInflater.from(context).inflate(R.layout.layout_popup_drop, null)
        val recyclerView = contentView.findViewById<RecyclerView>(R.id.recyclerView)
        recyclerView.layoutManager = LinearLayoutManager(context)
        recyclerView.adapter = SortAdapter()

        popupWindow = PopupWindow(contentView, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, true).apply {
    ...
    private inner class SortAdapter : RecyclerView.Adapter<SortAdapter.SortViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SortViewHolder {
            val view = LayoutInflater.from(context).inflate(R.layout.item_sort_option, parent, false)
        ...
        override fun onBindViewHolder(holder: SortViewHolder, position: Int) {
            ...
            holder.bg.visibility = if (position == selectedIndex) View.VISIBLE else View.INVISIBLE
        ...
        inner class SortViewHolder(view: View) : RecyclerView.ViewHolder(view) {
            ...
            val bg: View = view.findViewById(R.id.view_bg)
        }
    }
}
